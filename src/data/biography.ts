...
export const biographyChapters: BiographyChapter[] = [
  {
    ...
    chips: ["musical acoustics", "psychoacoustics", "auditory scene analysis", "sound direction"],
  ...
  },
  {
    ...
    chips: ["Doctor of Arts", "composition and music theory", "Fryderyk Chopin University of Music", "perceptual streaming"],
  ...
  },
  {
    ...
    chips: ["auditory streams", "auditory scene analysis", "multivariant perception", "musical reception"],
  ...
  },
  {
    ...
    chips: ["microphone techniques", "multichannel recording", "studio acoustics", "digital audio"],
  ...
  },
  {
    ...
    chips: ["monographs", "open access", "edited volumes", "Perspectives of Acoustics"],
  ...
  },
  {
    ...
    chips: ["peer review", "quadruple-blind review", "research quality", "scholarly standards"],
  ...
  },
  {
    ...
    chips: ["University of Warmia and Mazury", "Music Production and Sound Engineering", "recording studio", "curriculum design"],
  ...
  },
  {
    ...
    chips: ["visual arts", "multimedia", "intermedia art", "audiovisual projects"],
  ...
  },
  {
    ...
    chips: ["sound direction", "music production", "stereophonic recording", "multichannel systems"],
  ...
  },
  {
    ...
    chips: ["American Auditory Society", "AES", "IEEE", "ACM", "Polish Acoustical Society", "PSRD"],
  ...
  },
  {
    ...
    chips: ["music perception", "sound technology", "recording practice", "musical structure"],
